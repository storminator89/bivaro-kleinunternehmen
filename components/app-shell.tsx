            ...
            <div className="flex justify-between items-center">
              <Link href="/" className="flex items-center">
                <Image
                  src="/Bivaro_Logo.png"
                  alt="Bivaro Logo"
                  width={40} // Adjusted width based on original h-10
                  height={40} // Adjusted height based on original h-10
        ...
        <div className="sidebar-header relative p-4 pb-4 flex items-center justify-center">
          <Link href="/dashboard" className="brand-link text-xl font-bold text-foreground">
            <Image
              src="/Bivaro_Logo.png"
              alt="Bivaro Logo"
              width={48} // Adjusted width based on original h-12
              height={48} // Adjusted height based on original h-12
            ...
            <Image
              ...
              width={32} // Adjusted width based on original h-8
              height={32} // Adjusted height based on original h-8
